...
const nameDatabase: Record<string, { tribe: string; gender: 'male' | 'female'; meaning: string }> = {
  ...
  'efua': { tribe: 'fante', gender: 'female', meaning: 'Born on Friday - Akan day-naming' },
  'araba': { tribe: 'fante', gender: 'female', meaning: 'Born on Tuesday - Akan day-naming' },
  'esi': { tribe: 'fante', gender: 'female', meaning: 'Born on Sunday - Akan day-naming' },
  'kobina': { tribe: 'fante', gender: 'male', meaning: 'Born on Tuesday - Fante male form' },
  'kweku': { tribe: 'fante', gender: 'male', meaning: 'Born on Wednesday - Fante variant of Kwaku' },
  'ekow': { tribe: 'fante', gender: 'male', meaning: 'Born on Thursday - Fante variant' },
  'fiifi': { tribe: 'fante', gender: 'male', meaning: 'Born on Friday - Fante male form' },

  // ============ GHANA - Ga-Adangbe names - FACT-CHECKED 2024 ============
  'tetteh': { tribe: 'ga_adangbe', gender: 'male', meaning: 'First-born male - Ga naming tradition' },
  'nii': { tribe: 'ga_adangbe', gender: 'male', meaning: 'Chief/grandfather - Ga honorific prefix' },
  'okyne': { tribe: 'ga_adangbe', gender: 'male', meaning: 'Born on Wednesday - Ga day-naming' },
  'odartey': { tribe: 'ga_adangbe', gender: 'male', meaning: 'Third-born male - Ga birth-order name' },
  'nortey': { tribe: 'ga_adangbe', gender: 'male', meaning: 'Fourth-born male - Ga naming' },
  'quartey': { tribe: 'ga_adangbe', gender: 'male', meaning: 'Fifth-born male - Ga naming' },
  'amarteifio': { tribe: 'ga_adangbe', gender: 'male', meaning: 'Ancestral Ga family name' },
  'naa': { tribe: 'ga_adangbe', gender: 'female', meaning: 'Queen/grandmother - Ga female honorific' },
  'kai': { tribe: 'ga_adangbe', gender: 'female', meaning: 'Second-born female - Ga naming' },
  'dede': { tribe: 'ga_adangbe', gender: 'female', meaning: 'First-born female - Ga naming' },
  'ashiley': { tribe: 'ga_adangbe', gender: 'female', meaning: 'Ancestral Ga family name' },
  'koshie': { tribe: 'ga_adangbe', gender: 'female', meaning: 'Born on Sunday - Ga day-naming' },

  // ============ CAMEROON - Douala/Sawa names - FACT-CHECKED 2024 ============
  'mbella': { tribe: 'douala', gender: 'male', meaning: 'Great one - Douala royal name' },
  'dika_d': { tribe: 'douala', gender: 'male', meaning: 'Traditional Douala trading family name' },
  'manga': { tribe: 'douala', gender: 'male', meaning: 'Power/authority - Douala royal name (Manga Bell)' },
  'eyidi': { tribe: 'douala', gender: 'female', meaning: 'Traditional Douala female name' },
  'mundi': { tribe: 'douala', gender: 'female', meaning: 'Person/human - Douala name' },
};
