...
export function PersonCard({ person }: PersonCardProps) {
  ...
  return (
    <div className="p-3 bg-secondary rounded-lg flex gap-3 hover:bg-secondary/80 transition-colors group">
      <Link to={`/person/${personSlug}`} className="flex flex-1 min-w-0 gap-3">
        {hasImage ? (
